...
Adafruit_DCMotor *gearMotor_1 = AFMS.getMotor(1);
Adafruit_DCMotor *gearMotor_2 = AFMS.getMotor(2); 

Adafruit_StepperMotor *stepperMotor_1 = AFMS.getStepper(400, 2);
...
void setup() {
  ...
  stepperMotor_1->step(//steps, direction = FORWARD or BACKWARD, SINGLE or DOUBLE);
